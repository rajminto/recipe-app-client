...
class MenuIcon extends Component {
  ...
  render() {
    return (
      <div className={styles.container} onClick={this.burgerToggle}>
        <svg viewBox="0 0 493.168 493.168">
          <g id="cutlery">
            <path ref={fork => this.fork = fork} d="M306.734,0c-4.512,0-8.174,3.659-8.174,8.188v100.72c0,4.543-3.677,8.219-8.219,8.219
            ...
            <path ref={spoon => this.spoon = spoon} d="M87.935,0C63.423,0,30.912,66.013,30.912,116.405c0,33.214,11.124,51.245,27.742,59.689
            ...
            <path ref={knife => this.knife = knife} d="M440.218,232.891c3.098,0,5.602-2.503,5.602-5.603V9.825c0-5.427-4.397-9.825-9.837-9.825
